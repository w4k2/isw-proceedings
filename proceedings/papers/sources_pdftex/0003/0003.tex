...
\begin{abstract}
The scope of the research was to examine the balanced accuracy of machine learning models, such as Gaussian Naive Bayes, in classifying photos of bee frames, using a self-made dataset. The data were pre-processed by cropping, augmentation, RGB channel separation, and Histogram of Oriented Gradients (HOG). The Gaussian Naive Bayes model achieved approximately 90\% balanced accuracy in detecting the presence of cappings.
\end{abstract}
